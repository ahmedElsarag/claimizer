...
class MTextStyles {
  ...
  static const TextStyle textBoldDark24 = const TextStyle(
      fontSize: 24.0, color: MColors.text_dark, fontWeight: FontWeight.bold);

  static const TextStyle textBoldDark20 = const TextStyle(
      fontSize: 20.0, color: MColors.text_dark, fontWeight: FontWeight.bold);

  static const TextStyle textBoldDark26 = const TextStyle(
      fontSize: 26.0, color: MColors.text_dark, fontWeight: FontWeight.bold);
