...
class MColors {
  ...
  static const text_button_color = const Color(0xff1974D0);
  ...
  static final Color warningColor = Color(0xffA6264C);
  static final Color warningTextColor = Color(0xffA6264C);
