  ...
  static ThemeData lightTheme(BuildContext context) {
    return ThemeData(
      ...
      textTheme: TextTheme(
        ...
        displayMedium: GoogleFonts.montserrat(fontSize: 14.sp, fontWeight: FontWeight.w700, color: MColors.white),
        ...
        titleMedium: GoogleFonts.montserrat(fontSize: 5.sp),
        titleSmall: GoogleFonts.montserrat(fontSize: 6.sp),
        labelSmall: GoogleFonts.montserrat(fontSize: 10.sp,color: MColors.text_button_color, fontWeight: FontWeight.w500),
        labelMedium: GoogleFonts.montserrat(fontSize: 12.sp,fontWeight: FontWeight.w700, color: MColors.primary_text_color),
      ),
      //app themes
