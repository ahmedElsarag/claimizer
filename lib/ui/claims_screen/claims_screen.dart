                    ...
                    children: [
                      ...
                      Column(
                        ...
                        children: [
                          ...
                          Gaps.vGap8,
                          Text(
                              "${Setting.mobileLanguage.value == Locale("en") ? _dateFormatEN.format(pr.selectedDate) : _dateFormatAR.format(pr.selectedDate)} ${S.of(context).from} ${TimeFormatUtil.formatTimeOfDay(pr.selectedTime)}",
                              style: MTextStyles.textMain14.copyWith(
                                color: MColors.black,
                                fontWeight: FontWeight.w400,
                              )),
