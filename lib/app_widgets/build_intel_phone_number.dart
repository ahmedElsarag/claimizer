...
class IntlPhoneField extends StatefulWidget {
  ...
  final ValueChanged<Map<String, String>> onIsoCodeChanged;
  ...
  IntlPhoneField({
    ...
    this.errorColor = const Color(0xff602241),
  });
...
class _IntlPhoneFieldState extends State<IntlPhoneField> {
  Map<String, String> _selectedCountry = countries.firstWhere((item) => item['code'] == 'SA');
  List<Map<String, String>> filteredCountries =
      Setting.mobileLanguage.value == Locale("ar") ? countries_ar : countries;
  ...
  void initState() {
    ...
    if (widget.initialCountryCode != null) {
      _selectedCountry = Setting.mobileLanguage.value == Locale("ar")
          ? countries_ar
    ...
    validator = widget.autoValidate
        ? (value) => value.length != 10 ? "Enter valid phone number" : null
        : widget.validator;
  }
                ...
                TextField(
                  decoration: InputDecoration(
                      ...
                      hintStyle: Theme.of(context)
                          .textTheme
                          .subtitle1
                          .copyWith(fontWeight: FontWeight.w400,color:
                      MColors.gray),
                      ...
                      errorBorder: OutlineInputBorder(
                          borderRadius: BorderRadius.circular(12),
                          borderSide: BorderSide(color: MColors.dark_red)),
                  ...
                  onChanged: (value) {
                    setState(() {
                      filteredCountries =
                          Setting.mobileLanguage.value == Locale("ar")
                              ? countries_ar
                      ...
                      children: <Widget>[
                        ListTile(
                          ...
                          onTap: () {
                            ...
                            widget.onIsoCodeChanged(_selectedCountry);
    ...
    return TextFormField(
      ...
      decoration: /*widget.decoration*/
        ...
        border: OutlineInputBorder(
            ...
            borderSide: BorderSide(color: MColors.gray_ce, width: 1)),
        focusedBorder: OutlineInputBorder(
            borderRadius: BorderRadius.circular(8),
            borderSide: BorderSide(color: MColors.gray, width: 1)),
        errorBorder: OutlineInputBorder(
            borderRadius: BorderRadius.circular(8),
            borderSide: BorderSide(color: MColors.dart_red, width: 1)),
              ...
              children: <Widget>[
                ...
                FittedBox(
                  child: Text(
                    ...
                    style: TextStyle(
                        fontSize: 11.sp, color: widget.countryCodeTextColor),
                  ),
                ),
                // SizedBox(width: 10.w),
              ],
